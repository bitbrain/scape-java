...
public enum Messages {
   ...
   MENU_MAIN_PLAY_LOGIN("menu.main.play.login"),
   MENU_MAIN_PLAY_ACHIEVEMENTS("menu.main.play.achievements"),
   MENU_MAIN_PLAY_LEADERBOARDS("menu.main.play.leaderboards"),
